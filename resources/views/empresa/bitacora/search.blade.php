                    ...
                    <div class="accordion-item">
                        ...
                        <div id="collapseSpecialTitleOne" class="accordion-collapse collapse"
                            ...
                            <div class="accordion-body">
                                <form action="{{ url('bitacoras') }}" method="GET">
                                    @csrf
                                    <div class="row gx-3">
                                        ...
                                        <div class="col-md-2 mb-3">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <select name="tipo" class="form-select" aria-label="Default select example">
                                                    ...
                                                    <option value="Cuenta"{{ request('tipo') == 'Cuenta' ? ' selected' : '' }}>Cuenta</option>
                                                    <option value="Configuración"{{ request('tipo') == 'Configuración' ? ' selected' : '' }}>Configuración</option>
                                                </select>
                                            </div>
                                        </div>
