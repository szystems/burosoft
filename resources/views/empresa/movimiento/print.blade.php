                                    ...
                                    <div class="row gx-3">
                                        ...
                                        <div class="col-md-1 mb-3">
                                            <div class="form-check">
                                                <input class="form-check-input" name="fid" type="checkbox" value="1" id="flexCheckChecked" {{ (old('fid', 1) == 1 || request('fid') == 1) ? 'checked' : '' }}/>
                                        ...
                                        <div class="col-md-1 mb-3">
                                            <div class="form-check">
                                                <input class="form-check-input" name="ffecha" type="checkbox" value="1" id="flexCheckChecked" {{ (old('ffecha', 1) == 1 || request('ffecha') == 1) ? 'checked' : '' }}/>
                                        ...
                                        <div class="col-md-1 mb-3">
                                            <div class="form-check">
                                                <input class="form-check-input" name="fcuenta" type="checkbox" value="1" id="flexCheckChecked" {{ (old('fcuenta', 1) == 1 || request('fcuenta') == 1) ? 'checked' : '' }}/>
                                        ...
                                        <div class="col-md-1 mb-3">
                                            <div class="form-check">
                                                <input class="form-check-input" name="frubro" type="checkbox" value="1" id="flexCheckChecked" {{ (old('frubro', 1) == 1 || request('frubro') == 1) ? 'checked' : '' }}/>
                                        ...
                                        <div class="col-md-1 mb-3">
                                            <div class="form-check">
                                                <input class="form-check-input" name="fcargo" type="checkbox" value="1" id="flexCheckChecked" {{ (old('fcargo', 1) == 1 || request('fcargo') == 1) ? 'checked' : '' }}/>
                                        ...
                                        <div class="col-md-1 mb-3">
                                            <div class="form-check">
                                                <input class="form-check-input" name="festadosaldo" type="checkbox" value="1" id="flexCheckChecked" {{ (old('festadosaldo', 1) == 1 || request('festadosaldo') == 1) ? 'checked' : '' }}/>
                                                <label class="form-check-label" for="flexCheckChecked">Saldo</label>
                                            </div>
                                        </div>
                                        <div class="col-md-1 mb-3">
                                            <div class="form-check">
                                                <input class="form-check-input" name="fpagadosaldo" type="checkbox" value="1" id="flexCheckChecked" {{ (old('fpagadosaldo', 1) == 1 || request('fpagadosaldo') == 1) ? 'checked' : '' }}/>
                                        ...
                                        <div class="col-md-1 mb-3">
                                            <div class="form-check">
                                                <input class="form-check-input" name="fusuario" type="checkbox" value="1" id="flexCheckChecked" {{ (old('fusuario', 1) == 1 || request('fusuario') == 1) ? 'checked' : '' }}/>
                                        ...
                                        <div class="col-md-1 mb-3">
                                            <div class="form-check">
                                                <input class="form-check-input" name="fpagos" type="checkbox" value="1" id="flexCheckChecked" {{ (old('fpagos', 1) == 1 || request('fpagos') == 1) ? 'checked' : '' }}/>
                                                <label class="form-check-label" for="flexCheckChecked">Pagos</label>
                                            </div>
                                        </div>

                                        <input type="hidden" name="ffechadesde" value="{{ $request->input('fecha_desde') }}">
                                        <input type="hidden" name="ffechahasta" value="{{ $request->input('fecha_hasta') }}">
                                        <input type="hidden" name="ffcuenta" value="{{ $request->input('cuenta_id') }}">
                                        <input type="hidden" name="ffsaldo" value="{{ $request->input('saldo') }}">
                                        <input type="hidden" name="ffrubro" value="{{ $request->input('rubro_id') }}">
                                        <input type="hidden" name="ffusuario" value="{{ $request->input('usuario_id') }}">
