<!-- Modal -->
<div class="modal fade" id="editRrVaModal-{{ $rr->id }}" tabindex="-1" aria-labelledby="editRrVaModal-{{ $rr->id }}" aria-hidden="true">
    <div class="modal-dialog modal-xl modal-dialog-centered modal-dialog-scrollable">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="editRrVaModal-{{ $rr->id }}">
                    <i class="bi bi-pencil text-warning"></i> Editar Recurso de Revocatoria
                </h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>

            <form action="{{ url('update-rr/'.$rr->id) }}" method="POST" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                <div class="modal-body">
                    <div class="row gx-3">
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="datetime-local" name="fecha_hora_presentacion" class="form-control" value="{{ date('Y-m-d\TH:i', strtotime($rr->fecha_hora_presentacion)) }}" required>
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" name="numero_documento" class="form-control" value="{{ $rr->numero_documento }}" required>
                        ...
                        <div class="col-md-12 mb-3">
                            ...
                            <input type="text" name="oficina_agencia_ea" class="form-control" value="{{ $rr->oficina_agencia_ea }}" maxlength="300">
                        ...
                        <input type="hidden" name="audiencia_id" value="{{ $rr->audiencia_id }}">
                    </div>
                </div>
