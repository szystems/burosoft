<!-- Modal -->
<div class="modal fade" id="editResolucionModal-{{ $resolucion->id }}" tabindex="-1" aria-labelledby="editResolucionModal-{{ $resolucion->id }}" aria-hidden="true">
    <div class="modal-dialog modal-xl modal-dialog-centered modal-dialog-scrollable">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="editResolucionModal-{{ $resolucion->id }}">
                    <i class="bi bi-pencil text-warning"></i> Editar Resolucion
                </h5>
