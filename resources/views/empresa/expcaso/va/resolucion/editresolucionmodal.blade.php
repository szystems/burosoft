<!-- Modal -->
<div class="modal fade" id="editResolucionVaModal-{{ $resolucion->id }}" tabindex="-1" aria-labelledby="editResolucionVaModal-{{ $resolucion->id }}" aria-hidden="true">
    <div class="modal-dialog modal-xl modal-dialog-centered modal-dialog-scrollable">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="editResolucionVaModal-{{ $resolucion->id }}">
                    <i class="bi bi-pencil text-warning"></i> Editar R-SAT
                </h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>

            <form action="{{ url('update-resolucion/'.$resolucion->id) }}" method="POST" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                <div class="modal-body">
                    <div class="row gx-3">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <select name="tipo_resolucion" class="form-control" required onchange="toggleTipoResolucionOtroEdit{{ $resolucion->id }}(this.value)">
                        ...
                        <div class="col-md-6 mb-3" id="tipoResolucionOtroDiv{{ $resolucion->id }}" style="display: {{ $resolucion->tipo_resolucion == 'otro' ? 'block' : 'none' }};">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <select name="plazo_revocatoria" class="form-control" onchange="togglePlazoRevocatoriaOtroEdit{{ $resolucion->id }}(this.value)">
                        ...
                        <div class="col-md-6 mb-3" id="plazoRevocatoriaOtroDiv{{ $resolucion->id }}" style="display: {{ $resolucion->plazo_revocatoria == 'otro' ? 'block' : 'none' }};">
...
<script>
function toggleTipoResolucionOtroEdit{{ $resolucion->id }}(value) {
    const otroDiv = document.getElementById('tipoResolucionOtroDiv{{ $resolucion->id }}');
...
function togglePlazoRevocatoriaOtroEdit{{ $resolucion->id }}(value) {
    const otroDiv = document.getElementById('plazoRevocatoriaOtroDiv{{ $resolucion->id }}');
