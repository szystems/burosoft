<!-- Modal -->
<div class="modal fade" id="addEcVaModal" tabindex="-1" aria-labelledby="addEcVaModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-xl modal-dialog-centered modal-dialog-scrollable">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="addEcVaModalLabel">
                    <i class="bi bi-plus-circle text-success"></i> Agregar EC (Económico Coactivo)
                </h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>

            <form action="{{ url('insert-ec') }}" method="POST">
                @csrf
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" name="medidas_decretadas[]" value="Arraigo" id="medida_arraigo">
                                        <label class="form-check-label" for="medida_arraigo">Arraigo</label>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" name="medidas_decretadas[]" value="Bloqueo de cuentas" id="medida_cuentas">
                                        <label class="form-check-label" for="medida_cuentas">Bloqueo de cuentas</label>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" name="medidas_decretadas[]" value="Bloqueo de Vehiculos" id="medida_vehiculos">
                                        <label class="form-check-label" for="medida_vehiculos">Bloqueo de Vehículos</label>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" name="medidas_decretadas[]" value="Bloqueo de bienes inmuebles" id="medida_inmuebles">
                                        <label class="form-check-label" for="medida_inmuebles">Bloqueo de bienes inmuebles</label>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" name="medidas_decretadas[]" value="Interventor" id="medida_interventor">
                                        <label class="form-check-label" for="medida_interventor">Interventor</label>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-check">
                                        <input class="form-check-input medida-otro-checkbox" type="checkbox" name="medidas_decretadas[]" value="Otro" id="medida_otro" data-target="otro_field" data-input="medidas_decretadas_otro">
                                        <label class="form-check-label" for="medida_otro">Otro</label>
                                    </div>
                                </div>
                            </div>
                        </div>

                        <div class="col-md-12 mb-3" id="otro_field" style="display: none;">
