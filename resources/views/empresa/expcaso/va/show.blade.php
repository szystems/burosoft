                                                        ...
                                                        <div class="card-body">
                                                            <div class="custom-tabs-container">
                                                                <ul class="nav nav-tabs justify-content-center" id="expTap" role="tablist">
                                                                    ...
                                                                    <li class="nav-item" role="presentation">
                                                                        <a class="nav-link active" id="tab-va" data-bs-toggle="tab" href="#va" role="tab"
                                                                            aria-controls="va" aria-selected="true">VA
                                                                ...
                                                                <div class="tab-content" id="customTabContent">
                                                                    ...
                                                                    <div class="tab-pane fade show active" id="va" role="tabpanel">
                                                                        ...
                                                                        <div class="col-sm-12 col-12">
                                                                            <div class="row gx-3">
                                                                                <h4><strong>Listado de Audiencias</strong></h4>
                                                                                @if ($cuenta->estado == 1)
                                                                                ...
                                                                                @include('empresa.expcaso.va.addaudienciamodal')
                                                                                        ...
                                                                                        <tbody>
                                                                                            @foreach ($audiencias as $audiencia)
                                                                                                <tr>
                                                                                                    <td align="center">
                                                                                                        <div class="btn-group dropend">
                                                                                                            ...
                                                                                                            <ul class="dropdown-menu dropdown-menu-end dropdown-menu-lg-start">
                                                                                                                <li>
                                                                                                                    <a class="dropdown-item" href="{{ url('show-audiencia/'.$audiencia->id) }}"><i class="bi bi-eye-fill text-blue"></i> Información</a>
                                                                                                                </li>
                                                                                                                <li>
                                                                                                                    <a type="button" class="btn bg-gradient-warning" data-bs-toggle="modal" data-bs-target="#editAudienciaModal-{{ $audiencia->id }}">
                                                                                                                ...
                                                                                                                @if ($cuenta->estado == 1)
                                                                                                                    @if (Auth::user()->role_as == 0)
                                                                                                                        <li>
                                                                                                                            <a type="button" class="btn bg-gradient-danger" data-bs-toggle="modal" data-bs-target="#deleteAudienciaModal-{{ $audiencia->id }}">
                                                                                                    ...
                                                                                                    <td align="center">
                                                                                                        <a class="dropdown-item" href="{{ url('show-audiencia/'.$audiencia->id) }}">
                                                                                                            <p>{{ $audiencia->numero_audiencia }}</p>
                                                                                                        </a>
                                                                                                    </td>
                                                                                                    <td align="center">
                                                                                                        <a class="dropdown-item" href="{{ url('show-audiencia/'.$audiencia->id) }}">
                                                                                                    ...
                                                                                                    <td align="center">
                                                                                                        @if($audiencia->plazo_evacuar)
                                                                                                            @if($audiencia->plazo_evacuar == 'Otro' && $audiencia->plazo_evacuar_otro)
                                                                                                                <span class="badge bg-primary">{{ $audiencia->plazo_evacuar_otro }}</span>
                                                                                                            @else
                                                                                                                <span class="badge bg-info">{{ $audiencia->plazo_evacuar }}</span>
                                                                                                            @endif
                                                                                                        @else
                                                                                                            <span class="text-muted">-</span>
                                                                                                        @endif
