<!-- Modal -->
<div class="modal fade" id="editNulidadVaModal-{{ $nulidad->id }}" tabindex="-1" aria-labelledby="editNulidadVaModal-{{ $nulidad->id }}" aria-hidden="true">
    <div class="modal-dialog modal-xl modal-dialog-centered modal-dialog-scrollable">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="editNulidadVaModal-{{ $nulidad->id }}">
