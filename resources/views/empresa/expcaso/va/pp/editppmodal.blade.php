        ...
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="editPpModal-{{ $pp->id }}">
                    <i class="bi bi-pencil text-warning"></i> Editar Periodo de Prueba
                </h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>

            <form action="{{ url('update-pp/'.$pp->id) }}" method="POST" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                <div class="modal-body">
                    <div class="row gx-3">
                        ...
                        <input type="hidden" name="audiencia_id" value="{{ $pp->audiencia_id }}">
                    </div>
                </div>
