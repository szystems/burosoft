<!-- Modal -->
<div class="modal fade" id="addNtrrVaModal" tabindex="-1" aria-labelledby="addNtrrVaModal" aria-hidden="true">
    <div class="modal-dialog modal-xl modal-dialog-centered modal-dialog-scrollable">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="addNtrrVaModalLabel">
                    <i class="bi bi-plus text-success"></i> Agregar Negativa de Trámite Recurso de Revocatoria
                </h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>

            <form action="{{ url('insert-ntrr') }}" method="POST" enctype="multipart/form-data">
                @csrf
