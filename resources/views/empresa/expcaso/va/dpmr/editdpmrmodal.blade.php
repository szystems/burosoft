        ...
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="editDpmrModal-{{ $dpmr->id }}">
                    <i class="bi bi-pencil text-warning"></i> Editar Dpmracuación de Audiencia
                </h5>
                ...
                <div class="modal-body">
                    <div class="row gx-3">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" name="numero_resolucion" class="form-control" value="{{ $dpmr->numero_resolucion }}" required>
