<!-- Modal -->
<div class="modal fade" id="addActaAdministrativaModal" tabindex="-1"
aria-labelledby="addActaAdministrativaModal" aria-hidden="true">

<div class="modal-dialog modal-xl modal-dialog-centered modal-dialog-scrollable">
    <div class="modal-content">
        <div class="modal-header">
            <h5 class="modal-title" id="addActaAdministrativaModal">
                <i class="bi bi-plus text-success"></i> Agregar Acta Administrativa
            </h5>
            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
        </div>

        <form action="{{ url('insert-pat-actaadministrativa') }}" method="POST" enctype="multipart/form-data">
            @csrf
                ...
                <div class="row gx-3">
                    ...
                    <div class="col-md-12 mb-3">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea name="quienes_intervinieron" class="form-control" rows="3" placeholder="">{{ old('quienes_intervinieron') }}</textarea>
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <div class="mb-3">
                            ...
                            <select name="tipo_acta" class="form-select" aria-label="Default select example"  required>
                                ...
                                <option value="Limpia" {{ old('tipo_acta') == "Limpia" ? ' selected' : '' }}>Limpia</option>
                                <option value="Con Acuerdo" {{ old('tipo_acta') == "Con Acuerdo" ? ' selected' : '' }}>Con Acuerdo</option>
                                <option value="De Inconformidad" {{ old('tipo_acta') == "De Inconformidad" ? ' selected' : '' }}>De Inconformidad</option>
                                <option value="Otro" {{ old('tipo_acta') == "Otro" ? ' selected' : '' }}>Otro</option>
                            </select>
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <div class="mb-3">
                            ...
                            <input name="tipo_acta_otro" type="text" class="form-control" placeholder="Otro tipo de acta..." value="{{ old('tipo_acta_otro') }}"/>
