<!-- Modal -->
<div class="modal fade" id="addRafModal" tabindex="-1"
aria-labelledby="addRafModal" aria-hidden="true">
...
<div class="modal-dialog modal-xl modal-dialog-centered modal-dialog-scrollable">
    <div class="modal-content">
        ...
        <form action="{{ url('insert-pat-raf') }}" method="POST" enctype="multipart/form-data">
            @csrf
                ...
                <div class="row gx-3">
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <div class="mb-3">
                            ...
                            <input name="tipo_providencia_otro" type="text" class="form-control" placeholder="Otro tipo de raf..." value="{{ old('tipo_providencia_otro') }}"/>
