<!-- Modal -->
<div class="modal fade" id="addRoPaModal" tabindex="-1" aria-labelledby="addRoPaModal" aria-hidden="true">
    <div class="modal-dialog modal-xl modal-dialog-centered modal-dialog-scrollable">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="addRoPaModal">
                    <i class="bi bi-plus text-success"></i> Agregar Resolución de Ocurso (PA)
                </h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>

            <form action="{{ url('insert-ro-pa') }}" method="POST" enctype="multipart/form-data">
                @csrf
                    ...
                    <div class="row gx-3">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <select name="tipo_resolucion" class="form-control" required>
                                ...
                                <option value="Procede tramite" {{ old('tipo_resolucion') == 'Procede tramite' ? 'selected' : '' }}>Procede trámite</option>
                                <option value="No procede tramite" {{ old('tipo_resolucion') == 'No procede tramite' ? 'selected' : '' }}>No procede trámite</option>
                            </select>
