<!-- Modal -->
<div class="modal fade" id="addNtrrPaModal" tabindex="-1" aria-labelledby="addNtrrPaModal" aria-hidden="true">
    <div class="modal-dialog modal-xl modal-dialog-centered modal-dialog-scrollable">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="addNtrrPaModal">
                    <i class="bi bi-plus text-success"></i> Agregar Notificación de Trámite de Recurso de Revocatoria (PA)
                </h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>

            <form action="{{ url('insert-ntrr-pa') }}" method="POST" enctype="multipart/form-data">
                @csrf
