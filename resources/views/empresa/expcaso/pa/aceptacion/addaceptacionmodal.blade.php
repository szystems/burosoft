<!-- Modal -->
<div class="modal fade" id="addAceptacionPaModal" tabindex="-1" aria-labelledby="addAceptacionPaModal" aria-hidden="true">
    <div class="modal-dialog modal-xl modal-dialog-centered modal-dialog-scrollable">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="addAceptacionPaModalLabel">
                    <i class="bi bi-plus text-success"></i> Agregar Aceptación (PA)
                </h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>

            <form action="{{ url('insert-aceptacion-pa') }}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="modal-body">
                    <div class="row gx-3">

                        <input type="hidden" name="audiencia_pa_id" value="{{ $audiencia->id }}">
