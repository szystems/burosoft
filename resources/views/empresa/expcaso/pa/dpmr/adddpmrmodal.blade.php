<!-- Modal -->
<div class="modal fade" id="addDpmrPaModal" tabindex="-1" aria-labelledby="addDpmrPaModal" aria-hidden="true">
    <div class="modal-dialog modal-xl modal-dialog-centered modal-dialog-scrollable">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="addDpmrPaModal">
                    <i class="bi bi-plus text-success"></i> Agregar Diligencia Para Mejor Resolver (PA)
                </h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>

            <form action="{{ url('insert-dpmr-pa') }}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="modal-body">
                    <div class="row gx-3">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="number" class="form-control @error('numero_folios') is-invalid @enderror" id="numero_folios" name="numero_folios" value="{{ old('numero_folios') }}" min="1">
                            @error('numero_folios')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
