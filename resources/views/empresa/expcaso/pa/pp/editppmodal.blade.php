<!-- Modal -->
<div class="modal fade" id="editPpPaModal-{{ $pp->id }}" tabindex="-1" aria-labelledby="editPpPaModal-{{ $pp->id }}" aria-hidden="true">
    <div class="modal-dialog modal-xl modal-dialog-centered modal-dialog-scrollable">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="editPpPaModal-{{ $pp->id }}">
                    <i class="bi bi-pencil text-warning"></i> Editar Periodo de Prueba (PA)
                </h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>

            <form action="{{ url('update-pp-pa/'.$pp->id) }}" method="POST" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                <div class="modal-body">
                    <div class="row gx-3">
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="datetime-local" name="fecha_hora_presentacion" class="form-control" value="{{ date('Y-m-d\TH:i', strtotime($pp->fecha_hora_presentacion)) }}" required>
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" name="numero_documento" class="form-control" value="{{ $pp->numero_documento }}" required>
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <textarea name="observaciones" class="form-control" rows="3">{{ $pp->observaciones }}</textarea>
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="number" name="numero_folios" class="form-control" value="{{ $pp->numero_folios }}" min="1">
