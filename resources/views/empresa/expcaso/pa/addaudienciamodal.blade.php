            ...
            <div class="modal-body">
                <div class="row gx-3">
                    ...
                    <div class="col-md-4 mb-3">
                        ...
                        <select name="tipo_audiencia" id="tipo_audiencia" class="form-select" onchange="toggleTipoOtroFieldPa()" required>
                    ...
                    <div class="col-md-4 mb-3" id="otro_tipo_div_pa" style="display: {{ old('tipo_audiencia') == 'Otro' ? 'block' : 'none' }};">
...
function toggleTipoOtroFieldPa() {
    const tipoSelect = document.getElementById('tipo_audiencia');
    const otroDiv = document.getElementById('otro_tipo_div_pa');
