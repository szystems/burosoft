<!-- Modal -->
<div class="modal fade" id="addRtributaPaModal" tabindex="-1" aria-labelledby="addRtributaPaModal" aria-hidden="true">
    <div class="modal-dialog modal-xl modal-dialog-centered modal-dialog-scrollable">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="addRtributaPaModal">
                    <i class="bi bi-plus text-success"></i> Agregar Resolución Tributaria (PA)
                </h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>

            <form action="{{ url('insert-rtributa-pa') }}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="modal-body">
                    <div class="row gx-3">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="datetime-local" name="fecha_hora_notificacion" class="form-control" value="{{ old('fecha_hora_notificacion') }}" required>
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <select name="tipo_resolucion" id="tipo_resolucion_add_pa" class="form-control" required onchange="toggleTipoResolucionOtroPa('add')">
                        ...
                        <div class="col-md-6 mb-3" id="tipo_resolucion_otro_add_pa" style="display: {{ old('tipo_resolucion') == 'otro' ? 'block' : 'none' }};">
                            <label for="tipo_resolucion_otro" class="form-label">Especifique Tipo de Resolución <span class="text-danger">*</span></label>
                            <input type="text" 
                                   {{ old('tipo_resolucion') == 'otro' ? 'name=tipo_resolucion_otro' : '' }}
                                   class="form-control" 
                                   value="{{ old('tipo_resolucion_otro') }}">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <select name="plazo_cat" id="plazo_cat_add_pa" class="form-control" onchange="togglePlazoCatOtroPa('add')">
                                <option value="">Seleccione...</option>
                        ...
                        <div class="col-md-6 mb-3" id="plazo_cat_otro_add_pa" style="display: {{ old('plazo_cat') == 'otro' ? 'block' : 'none' }};">
                            <label for="plazo_cat_otro" class="form-label">Especifique Plazo CAT <span class="text-danger">*</span></label>
                            <input type="text" 
                                   {{ old('plazo_cat') == 'otro' ? 'name=plazo_cat_otro' : '' }}
                                   class="form-control" 
                                   value="{{ old('plazo_cat_otro') }}">
