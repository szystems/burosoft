<!-- Modal -->
<div class="modal fade" id="addEvPaModal" tabindex="-1" aria-labelledby="addEvPaModal" aria-hidden="true">
    <div class="modal-dialog modal-xl modal-dialog-centered modal-dialog-scrollable">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="addEvPaModal">
                    <i class="bi bi-plus text-success"></i> Agregar Evacuación de Audiencia PA
                </h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>

            <form action="{{ url('insert-ev-pa') }}" method="POST" enctype="multipart/form-data">
                @csrf
