                ...
                <div class="modal-body">
                    <div class="row gx-3">
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="datetime-local" name="fecha_hora_presentacion" class="form-control" 
                                   value="{{ $rr->fecha_hora_presentacion ? \Carbon\Carbon::parse($rr->fecha_hora_presentacion)->format('Y-m-d\TH:i') : '' }}" required>
