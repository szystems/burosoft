<!-- Modal -->
<div class="modal fade" id="editOcursoPaModal-{{ $ocurso->id }}" tabindex="-1" aria-labelledby="editOcursoPaModal-{{ $ocurso->id }}" aria-hidden="true">
    <div class="modal-dialog modal-xl modal-dialog-centered modal-dialog-scrollable">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="editOcursoPaModal-{{ $ocurso->id }}">
                    <i class="bi bi-pencil text-warning"></i> Editar Ocurso (PA)
                </h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>

            <form action="{{ url('update-ocurso-pa/'.$ocurso->id) }}" method="POST" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                <div class="modal-body">
                    <div class="row gx-3">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <textarea name="observaciones" class="form-control" rows="3">{{ $ocurso->observaciones }}</textarea>
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="number" name="numero_folios" class="form-control" value="{{ $ocurso->numero_folios }}" min="1">
                        ...
                        <input type="hidden" name="audiencia_pa_id" value="{{ $ocurso->audiencia_pa_id }}">
                    </div>
                </div>
