                                    ...
                                    <div class="tab-pane fade show active" id="oneA" role="tabpanel">
                                        ...
                                        <div class="row gx-3">
                                            <div class="col-sm-12 col-12">
                                                ...
                                                @endif
                                                <form action="{{ url('update-rubro/'.$rubro->id) }}" method="POST">
                                                    @csrf
                                                    @method('PUT')
                                                    <div class="row gx-3">
                                                        ...
                                                        <div class="col-md-3 mb-3">
                                                            ...
                                                            <div class="mb-3">
                                                                ...
                                                                <input name="nombre" type="text" class="form-control" placeholder="Nombre..." value="{{ $rubro->nombre }}" />
                                                        ...
                                                        <div class="col-md-12 mb-3">
                                                            ...
                                                            <div class="mb-3">
                                                                ...
                                                                <textarea name="descripcion" class="form-control" rows="3" placeholder="Descripción...">{{ $rubro->descripcion }}</textarea>
