                    ...
                    <div class="accordion-item">
                        <h2 class="accordion-header" id="headingSpecialTitleTwo">
                            <button class="accordion-button" type="button" data-bs-toggle="collapse"
                                ...
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="ms-3">
                                        <h5 class="text-yellow">Imprimir RSI</h5>
                                    </div>
                                </div>
                            </button>
                        </h2>
                        <div id="collapseSpecialTitleTwo" class="accordion-collapse collapse"
                            ...
                            <div class="accordion-body">
                                <form action="{{ url('pdf-rsi') }}" method="GET" target="_blank">
                                    <div class="row gx-3">
                                        ...
                                        <input type="hidden" name="ffcuenta" value="{{ $request->cuenta_id ?? '' }}">
                                        <input type="hidden" name="ffsaldo" value="{{ $request->saldo ?? '' }}">
