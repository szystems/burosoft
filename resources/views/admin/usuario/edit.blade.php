                                        ...
                                        <div class="tab-pane fade show active" id="oneA" role="tabpanel">
                                            ...
                                            <div class="row gx-3">
                                                ...
                                                <div class="col-sm-12 col-12">
                                                    ...
                                                    @endif
                                                    <form action="{{ url('update-usuario/'.$user->id) }}" method="POST" enctype="multipart/form-data">
                                                        @csrf
                                                        @method('PUT')
                                                        <div class="row gx-3">
                                                            ...
                                                            <div class="col-md-3 mb-3">
                                                                ...
                                                                <div class="mb-3">
                                                                    ...
                                                                    <select name="empresa_id" class="form-select">
                                                                        <option selected value="{{ $user->empresa_id }}">{{ $user->empresa->nombre }}</option>
                                                        ...
                                                        <div class="d-flex gap-2 justify-content-center">
                                                            <a href="{{ url('show-usuario/'.$user->id) }}" type="button" class="btn btn-danger">
