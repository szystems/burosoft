                                                    ...
                                                    <div class="row gx-3">
                                                        ...
                                                        <div class="col-md-3 mb-3">
                                                            ...
                                                            <div class="mb-3">
                                                                ...
                                                                <input name="nombre" type="text" class="form-control" placeholder="Nombre de la empresa..." value="{{ $empresa->nombre }}" />
                                                        ...
                                                        <div class="col-md-3 mb-3">
                                                            ...
                                                            <div class="mb-3">
                                                                ...
                                                                <input name="telefono" type="number" oninput="this.value = this.value.replace(/[^0-9]/g, '');" class="form-control" placeholder="Teléfono de la empresa..." value="{{ $empresa->telefono }}" />
                                                        ...
                                                        <div class="col-md-3 mb-3">
                                                            ...
                                                            <div class="mb-3">
                                                                ...
                                                                <input name="celular" type="number" oninput="this.value = this.value.replace(/[^0-9]/g, '');" class="form-control" placeholder="Celular de la empresa..." value="{{ $empresa->celular }}"/>
                                                                @if ($errors->has('telefono'))
                                                                    <span class="help-block opacity-7">
                                                                            <strong>
                                                        ...
                                                        <div class="col-md-3 mb-3">
                                                            ...
                                                            <div class="mb-3">
                                                                ...
                                                                <input name="email" type="text" class="form-control" placeholder="Correo electronico de la empresa..." value="{{ $empresa->email }}" />
                                                                @if ($errors->has('email'))
                                                                    <span class="help-block opacity-7">
                                                                            <strong>
                                                        ...
                                                        <div class="col-md-12 mb-3">
                                                            ...
                                                            <div class="mb-3">
                                                                ...
                                                                <textarea name="direccion" class="form-control" rows="3" placeholder="Dirección de la empresa...">{{ $empresa->direccion }}</textarea>
                                                        ...
                                                        <div class="col-md-4 mb-3">
                                                            ...
                                                            <div class="mb-3">
                                                                ...
                                                                <textarea name="descripcion" class="form-control" rows="3" placeholder="Descripción de la empresa...">{{ $empresa->descripcion }}</textarea>
                                                        ...
                                                        <div class="col-md-4 mb-3">
                                                            ...
                                                            <div class="mb-3">
                                                                ...
                                                                <input type="file" name="fotografia" class="form-control border" value="{{ $empresa->fotografia }}">
