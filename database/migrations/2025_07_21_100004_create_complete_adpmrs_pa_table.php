...
class CreateCompleteAdpmrsPaTable extends Migration
{
    /**
     * Run the migrations.
     * 
     * Esta migración consolida las siguientes migraciones fragmentadas:
     * - 2025_07_21_100004_create_adpmrs_pa_table.php (estructura base)
     * - 2025_08_22_094659_add_oficina_presentacion_to_adpmrs_pa_table.php (campo oficina)
     *
     * @return void
     */
    public function up()
    {
        Schema::create('adpmrs_pa', function (Blueprint $table) {
            $table->id();
