...
class CreateCompletePpsTable extends Migration
{
    /**
     * Run the migrations.
     * 
     * Esta migración consolida las siguientes migraciones fragmentadas:
     * - 2025_03_03_101852_create_pps_table.php (estructura base)
     * - 2025_08_22_000003_add_oficina_presentacion_to_pps_table.php (campo oficina)
     *
     * @return void
     */
    public function up()
